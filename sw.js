...
const ASSETS = [
  ...
  './big2go-result-story.css?v=5',
  './big2go-level-up.css?v=10',
  './big2go-profile.css?v=3',
  './big2go-landing-v3.css?v=33',
  './big2go-play-demo.css?v=3',
  './big2go-gameplay-premium.css?v=30',
  './big2go-private-room.css?v=3',
  './big2go-five-card-party.css?v=2',
  './big2go-language.css?v=3',
  './big2go-device-widths.css?v=1',
