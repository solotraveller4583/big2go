...
(function () {
  ...
  const MESSAGES = {
    en: {
      ...
      'game.fiveCardParty': '5 CARDS!',
      'game.fiveCardPartyYou': 'You are down to 5 cards — party time!',
      'game.fiveCardPartyOther': '{name} is down to 5 cards!',
      'game.fiveCardPartyHeat': '5 cards left — celebration time!',
      'game.online': 'Online',
    ...
    th: {
      ...
      'game.fiveCardParty': 'เหลือ 5 ใบ!',
      'game.fiveCardPartyYou': 'คุณเหลือไพ่ 5 ใบ — มาฉลองกัน!',
      'game.fiveCardPartyOther': '{name} เหลือไพ่ 5 ใบ!',
      'game.fiveCardPartyHeat': 'เหลือ 5 ใบ — ฉลองกัน!',
      'game.online': 'ออนไลน์',
    ...
    zh: {
      ...
      'game.cards': '{count} 张',
      'game.lastCard': '最后一张',
      'game.fiveCardParty': '剩5张!',
      'game.fiveCardPartyYou': '你只剩5张牌——庆祝一下！',
      'game.fiveCardPartyOther': '{name} 只剩5张牌！',
      'game.fiveCardPartyHeat': '剩5张——庆祝时刻！',
      'game.online': '在线',
      'game.offline': '离线',
    ...
    ja: {
      ...
      'game.fiveCardParty': '残り5枚!',
      'game.fiveCardPartyYou': '残り5枚——お祝いの時間！',
      'game.fiveCardPartyOther': '{name}が残り5枚！',
      'game.fiveCardPartyHeat': '残り5枚——お祝い！',
      'game.online': 'オンライン',
      'game.offline': 'オフライン',
    ...
    ko: {
      ...
      'game.fiveCardParty': '5장 남음!',
      'game.fiveCardPartyYou': '5장 남았어요 — 축하 시간!',
      'game.fiveCardPartyOther': '{name}님이 5장 남았어요!',
      'game.fiveCardPartyHeat': '5장 남음 — 축하!',
      'game.online': '온라인',
      'game.offline': '오프라인',
