...
(function () {
  ...
  const MESSAGES = {
    en: {
      ...
      'room.statusInvite': 'You were invited. Enter your name and tap Join Room.',
    ...
    th: {
      ...
      'room.statusInvite': 'คุณได้รับคำเชิญ ใส่ชื่อแล้วแตะเข้าห้อง',
    ...
    zh: {
      ...
      'room.statusInvite': '你收到了邀请，输入昵称后点击加入房间',
    ...
    ja: {
      ...
      'room.statusInvite': '招待されました。名前を入力して参加をタップ',
    ...
    ko: {
      ...
      'room.statusInvite': '초대받았습니다. 닉네임 입력 후 룸 참가를 누르세요',
