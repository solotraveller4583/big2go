...
(function () {
  ...
  const MESSAGES = {
    en: {
      ...
      'game.chatClose': 'Tap to close',
      'game.chatPlaceholder': 'Say something…',
      'game.chatSend': 'Send',
      'game.chatNice': 'Nice move',
      'game.chatGood': 'Good game',
      'game.chatHurry': 'Hurry up',
      'game.voicePrimary': 'Voice',
      'game.textFallback': 'Text',
      'game.textFallbackNote': 'Text backup when voice is unavailable.',
      'game.voiceTapEnable': 'Tap mic to enable voice',
      'game.voiceMicOff': 'Mic off — tap to unmute',
      'game.voiceMicOn': 'Mic on — friends can hear you',
      'game.voiceMicLive': 'You are live',
      'game.voiceTapHear': 'Tap table to hear friends',
      'game.voiceSpeakerOff': 'Speaker muted — tap to hear friends',
      'game.voiceMicOnLabel': 'Turn microphone off',
      'game.voiceSpeaking': 'Speaking now',
      'game.voiceConnected': 'Voice connected',
      'game.voiceOff': 'Voice off',
    ...
    th: {
      ...
      'game.chatClose': 'แตะเพื่อปิด',
      'game.chatPlaceholder': 'พิมพ์ข้อความ…',
      'game.chatSend': 'ส่ง',
      'game.chatNice': 'ไม้ดี',
      'game.chatGood': 'เกมดี',
      'game.chatHurry': 'รีบหน่อย',
      'game.voicePrimary': 'เสียง',
      'game.textFallback': 'ข้อความ',
      'game.textFallbackNote': 'สำรองเมื่อเสียงใช้ไม่ได้',
      'game.voiceTapEnable': 'แตะไมค์เพื่อเปิดเสียง',
      'game.voiceMicOff': 'ปิดไมค์ — แตะเพื่อเปิด',
      'game.voiceMicOn': 'เปิดไมค์ — เพื่อนได้ยินคุณ',
      'game.voiceMicLive': 'กำลังพูด',
      'game.voiceTapHear': 'แตะโต๊ะเพื่อฟังเพื่อน',
      'game.voiceSpeakerOff': 'ปิดลำโพง — แตะเพื่อฟังเพื่อน',
      'game.voiceMicOnLabel': 'ปิดไมโครโฟน',
      'game.voiceSpeaking': 'กำลังพูด',
      'game.voiceConnected': 'เชื่อมเสียงแล้ว',
      'game.voiceOff': 'ปิดเสียง',
    ...
    zh: {
      ...
      'game.chatGood': '好局',
      'game.chatHurry': '快点',
      'game.voicePrimary': '语音',
      'game.textFallback': '文字',
      'game.textFallbackNote': '语音不可用时的备用文字聊天。',
      'game.voiceTapEnable': '点按麦克风开启语音',
      'game.voiceMicOff': '麦克风已关 — 点按开启',
      'game.voiceMicOn': '麦克风已开 — 好友可听到你',
      'game.voiceMicLive': '正在说话',
      'game.voiceTapHear': '点按桌面以听到好友',
      'game.voiceSpeakerOff': '扬声器已静音 — 点按开启',
      'game.voiceMicOnLabel': '关闭麦克风',
      'game.voiceSpeaking': '正在说话',
      'game.voiceConnected': '语音已连接',
      'game.voiceOff': '语音关闭',
    ...
    ja: {
      ...
      'game.chatClose': 'タップで閉じる',
      'game.chatPlaceholder': 'メッセージを入力…',
      'game.chatSend': '送信',
      'game.chatNice': 'ナイス',
      'game.chatGood': 'GG',
      'game.chatHurry': '急いで',
      'game.voicePrimary': 'ボイス',
      'game.textFallback': '文字',
      'game.textFallbackNote': 'ボイスが使えない時のテキスト备用。',
      'game.voiceTapEnable': 'マイクをタップしてボイスを有効化',
      'game.voiceMicOff': 'マイクOFF — タップでON',
      'game.voiceMicOn': 'マイクON — 友達に聞こえます',
      'game.voiceMicLive': '話し中',
      'game.voiceTapHear': 'テーブルをタップして友達の声を聞く',
      'game.voiceSpeakerOff': 'スピーカーOFF — タップでON',
      'game.voiceMicOnLabel': 'マイクをオフ',
      'game.voiceSpeaking': '話し中',
      'game.voiceConnected': 'ボイス接続中',
      'game.voiceOff': 'ボイスOFF',
    ...
    ko: {
      ...
      'game.chatClose': '탭하여 닫기',
      'game.chatPlaceholder': '메시지 입력…',
      'game.chatSend': '보내기',
      'game.chatNice': '좋은 수',
      'game.chatGood': 'GG',
      'game.chatHurry': '빨리',
      'game.voicePrimary': '음성',
      'game.textFallback': '텍스트',
      'game.textFallbackNote': '음성을 쓸 수 없을 때 텍스트 대체.',
      'game.voiceTapEnable': '마이크를 눌러 음성 켜기',
      'game.voiceMicOff': '마이크 꺼짐 — 눌러 켜기',
      'game.voiceMicOn': '마이크 켜짐 — 친구가 들을 수 있어요',
      'game.voiceMicLive': '말하는 중',
      'game.voiceTapHear': '테이블을 눌러 친구 목소리 듣기',
      'game.voiceSpeakerOff': '스피커 음소거 — 눌러 켜기',
      'game.voiceMicOnLabel': '마이크 끄기',
      'game.voiceSpeaking': '말하는 중',
      'game.voiceConnected': '음성 연결됨',
      'game.voiceOff': '음성 꺼짐',
