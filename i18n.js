...
(function () {
  ...
  const MESSAGES = {
    en: {
      ...
      'game.privateLounge': 'Private Lounge',
      'game.privateStatus': '{requirement} · Round {round}',
      'game.roomCode': 'Room',
      'game.roomLabel': 'ROOM {code}',
      'game.voiceLounge': 'Voice Lounge',
      'game.voiceTapMic': 'Tap mic to talk with friends',
      'game.voiceLiveBadge': 'LIVE',
      'game.voiceMuted': 'Mic off — tap to unmute',
      'game.voiceBroadcasting': 'You are live on voice',
      'game.voiceReady': 'Voice connected — tap mic to talk',
      'game.voiceMicOn': 'Turn microphone off',
      'game.voiceMicOff': 'Turn microphone on',
      'game.voiceSpeaking': '{name} is speaking',
      'game.voiceOn': '{name} on voice',
      'game.voiceOff': '{name} voice off',
      'game.voiceBannerOne': '{name} is speaking',
      'game.voiceBannerMany': '{names} are speaking',
      ...
      'room.vipTagline': 'Voice lounge for friends',
      'room.voiceFirst': 'Voice chat is how you talk at the table — no typing needed.',
      'room.you': 'You',
      'room.host': 'Host'
    },
    th: {
      ...
      'game.privateLounge': 'ห้องส่วนตัว VIP',
      'game.privateStatus': '{requirement} · รอบ {round}',
      'game.roomCode': 'ห้อง',
      'game.roomLabel': 'ห้อง {code}',
      'game.voiceLounge': 'เลานจ์เสียง',
      'game.voiceTapMic': 'แตะไมค์เพื่อคุยกับเพื่อน',
      'game.voiceLiveBadge': 'สด',
      'game.voiceMuted': 'ปิดไมค์ — แตะเพื่อเปิด',
      'game.voiceBroadcasting': 'คุณกำลังพูดอยู่',
      'game.voiceReady': 'เชื่อมเสียงแล้ว — แตะไมค์เพื่อพูด',
      'game.voiceMicOn': 'ปิดไมโครโฟน',
      'game.voiceMicOff': 'เปิดไมโครโฟน',
      'game.voiceSpeaking': '{name} กำลังพูด',
      'game.voiceOn': '{name} เปิดเสียง',
      'game.voiceOff': '{name} ปิดเสียง',
      'game.voiceBannerOne': '{name} กำลังพูด',
      'game.voiceBannerMany': '{names} กำลังพูด',
      ...
      'room.vipTagline': 'เลานจ์เสียงสำหรับเพื่อน',
      'room.voiceFirst': 'ใช้เสียงคุยที่โต๊ะ — ไม่ต้องพิมพ์ข้อความ',
      'room.you': 'คุณ',
    ...
    zh: {
      ...
      'game.chatGood': '好局',
      'game.chatHurry': '快点',
      'game.privateLounge': '私人贵宾厅',
      'game.privateStatus': '{requirement} · 第 {round} 局',
      'game.roomCode': '房间',
      'game.roomLabel': '房间 {code}',
      'game.voiceLounge': '语音休息室',
      'game.voiceTapMic': '点击麦克风与好友通话',
      'game.voiceLiveBadge': '直播',
      'game.voiceMuted': '麦克风已关 — 点击开启',
      'game.voiceBroadcasting': '你正在语音中',
      'game.voiceReady': '语音已连接 — 点击麦克风说话',
      'game.voiceMicOn': '关闭麦克风',
      'game.voiceMicOff': '开启麦克风',
      'game.voiceSpeaking': '{name} 正在说话',
      'game.voiceOn': '{name} 已开语音',
      'game.voiceOff': '{name} 已关语音',
      'game.voiceBannerOne': '{name} 正在说话',
      'game.voiceBannerMany': '{names} 正在说话',
      ...
      'room.vipTagline': '好友语音贵宾厅',
      'room.voiceFirst': '用语音在牌桌交流 — 无需打字聊天',
      'room.you': '你',
      'room.host': '房主'
    },
    ja: {
      ...
      'game.chatGood': 'GG',
      'game.chatHurry': '急いで',
      'game.privateLounge': 'プライベートラウンジ',
      'game.privateStatus': '{requirement} · ラウンド {round}',
      'game.roomCode': 'ルーム',
      'game.roomLabel': 'ルーム {code}',
      'game.voiceLounge': 'ボイスラウンジ',
      'game.voiceTapMic': 'マイクをタップして友達と話す',
      'game.voiceLiveBadge': 'LIVE',
      'game.voiceMuted': 'マイクOFF — タップでON',
      'game.voiceBroadcasting': 'ボイス配信中',
      'game.voiceReady': 'ボイス接続済み — マイクをタップ',
      'game.voiceMicOn': 'マイクをオフ',
      'game.voiceMicOff': 'マイクをオン',
      'game.voiceSpeaking': '{name} が話しています',
      'game.voiceOn': '{name} ボイスON',
      'game.voiceOff': '{name} ボイスOFF',
      'game.voiceBannerOne': '{name} が話しています',
      'game.voiceBannerMany': '{names} が話しています',
      ...
      'room.vipTagline': '友達向けボイスラウンジ',
      'room.voiceFirst': 'テーブルではボイスチャット — 文字入力は不要',
      'room.you': 'あなた',
      'room.host': 'ホスト'
    },
    ko: {
      ...
      'game.chatGood': 'GG',
      'game.chatHurry': '빨리',
      'game.privateLounge': '프라이빗 라운지',
      'game.privateStatus': '{requirement} · {round}라운드',
      'game.roomCode': '방',
      'game.roomLabel': '방 {code}',
      'game.voiceLounge': '보이스 라운지',
      'game.voiceTapMic': '마이크를 눌러 친구와 대화하세요',
      'game.voiceLiveBadge': 'LIVE',
      'game.voiceMuted': '마이크 꺼짐 — 탭하여 켜기',
      'game.voiceBroadcasting': '음성 송출 중',
      'game.voiceReady': '음성 연결됨 — 마이크를 탭하세요',
      'game.voiceMicOn': '마이크 끄기',
      'game.voiceMicOff': '마이크 켜기',
      'game.voiceSpeaking': '{name}이(가) 말하는 중',
      'game.voiceOn': '{name} 음성 켜짐',
      'game.voiceOff': '{name} 음성 꺼짐',
      'game.voiceBannerOne': '{name}이(가) 말하는 중',
      'game.voiceBannerMany': '{names}이(가) 말하는 중',
      ...
      'room.vipTagline': '친구를 위한 보이스 라운지',
      'room.voiceFirst': '테이블에서는 보이스 채팅 — 타이핑 불필요',
      'room.you': '나',
      'room.host': '호스트'
    }
  };
